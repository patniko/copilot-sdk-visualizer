...
export const RUNTIME_OPTIONS = [
    {
        ...
        note: "The established default. A process boundary is not a filesystem, network, or tenant sandbox.",
    },
    {
        id: "external",
        ...
        note: "Start and secure the service yourself. Disconnecting a client must not be treated as shutting down the shared service.",
    },
    {
        id: "inprocess",
