...
- Explore a dedicated **Runtime** page (`/#runtime`) without changing your draft: select capabilities, inspect ownership and evidence, or step through an illustrative model/tool turn.
...
| `src/domain/presets.ts`              | Starting profiles and baseline differences.                                                       |
